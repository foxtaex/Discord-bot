...
die ersten 25 konfigurierten Kategorien.
...
ausgewaehlt werden. Nach Aenderungen muss mit `/ticket-panel` ein neues Panel
gesendet werden; bereits gesendete Dropdowns koennen nicht nachtraeglich
veraendert werden.
